...
Version  : 1.0.8.3
Release  : 117
URL      : https://cran.r-project.org/src/contrib/Rcpp_1.0.8.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Rcpp_1.0.8.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647530940
...
/usr/lib64/R/library/Rcpp/tinytest/testRcppInterfaceExporter/src/config.h
